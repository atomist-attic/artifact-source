...
class JGitServicesTest extends GitHubMutatorTest(Token) {

  private val gs = JGitServices(Token)

  "JGitServices" should "create and edit a new file, and create a pull request" in {
    ...
    gs.createBranchFromChanges(repo, owner, updatedBranch, startAs, editedAgain, "Added files")
