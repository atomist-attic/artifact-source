...
import com.atomist.source.{ArtifactSourceException, SimpleSourceUpdateInfo, TestUtils}
...
class FileSystemArtifactSourceWriterTest extends FlatSpec with Matchers {
  ...
  "FileSystemArtifactSourceWriter" should "fail with bogus file id" in {
    ...
    an[ArtifactSourceException] should be thrownBy fWriter.write(ValidSource, fid, SimpleSourceUpdateInfo(getClass.getName))
  }
